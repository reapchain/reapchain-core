...
// XXX: this func should probably be called by cmd/reapchain/commands/init.go
...
# Might be either absolute path or path related to Reapchain's config directory.
# NOTE: both tls-cert-file and tls-key-file must be present for Reapchain to create HTTPS server.
# Otherwise, HTTP server is run.
