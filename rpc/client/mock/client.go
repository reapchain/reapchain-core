...
want to directly call a reapchain node in process, you can use the
"local" package.
*/
...
func (c Client) Qns(ctx context.Context, height *int64) (*ctypes.ResultQns, error) {
	return core.Qns(&rpctypes.Context{}, height)
}
