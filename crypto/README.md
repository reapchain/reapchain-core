...
JSON encoding is done using reapchain's internal json encoder. For more information on JSON encoding, please refer to [Reapchain JSON encoding](https://github.com/tendermint/tendermint/blob/ccc990498df70f5a3df06d22476c9bb83812cbe3/libs/json/doc.go)
