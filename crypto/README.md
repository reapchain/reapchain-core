...
crypto is the cryptographic package adapted for ReapchainCore's uses
...
For Binary encoding, please refer to the [ReapchainCore encoding specification](https://docs.reapchain-core.com/master/spec/blockchain/encoding.html).

## JSON Encoding

JSON encoding is done using reapchain-core's internal json encoder. For more information on JSON encoding, please refer to [ReapchainCore JSON encoding](https://github.com/reapchain/reapchain-core/blob/ccc990498df70f5a3df06d22476c9bb83812cbe3/libs/json/doc.go)
