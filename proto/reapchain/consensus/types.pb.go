...
type Message_Vrfn struct {
	Vrfn *Vrf `protobuf:"bytes,11,opt,name=vrfn,proto3,oneof" json:"vrfn,omitempty"`
}
...
func (*Message_Vrfn) isMessage_Sum()          {}
...
func (m *Message) GetVrfn() *Vrf {
	if x, ok := m.GetSum().(*Message_Vrfn); ok {
		return x.Vrfn
	}
	return nil
}
...
var fileDescriptor_8cf0e5fe0c954c53 = []byte{
	...
	,
}
...
func (m *Message_Vrfn) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_Vrfn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Vrfn != nil {
		{
			size, err := m.Vrfn.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_Vrfn) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Vrfn", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
