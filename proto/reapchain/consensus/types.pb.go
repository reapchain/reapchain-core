...
import (
	...
	bits "gitlab.reappay.net/reapchain/reapchain-core/proto/reapchain/libs/bits"
...
type Qn struct {
	Qn *types.Qn `protobuf:"bytes,1,opt,name=qn,proto3" json:"qn,omitempty"`
}
...
type Message_Qn struct {
	Qn *Qn `protobuf:"bytes,10,opt,name=qn,proto3,oneof" json:"qn,omitempty"`
}
...
func (m *Message) GetQn() *Qn {
	if x, ok := m.GetSum().(*Message_Qn); ok {
		return x.Qn
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*Qn)(nil), "reapchain.consensus.Qn")
...
var fileDescriptor_8cf0e5fe0c954c53 = []byte{
	...
	,
}
...
func (m *Message_Qn) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_Qn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Qn != nil {
		{
			size, err := m.Qn.MarshalToSizedBuffer(dAtA[:i])
