...
import (
	...
	version "github.com/tendermint/tendermint/proto/reapchain/version"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
func init() { proto.RegisterFile("reapchain/types/types.proto", fileDescriptor_d3a6e55e2345de56) }
