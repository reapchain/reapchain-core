...
type ConsensusParams struct {
	...
	Qn             QnParams             `protobuf:"bytes,6,opt,name=qn,proto3" json:"qn"`
}
...
func (m *ConsensusParams) GetQn() QnParams {
	if m != nil {
		return m.Qn
	}
	return QnParams{}
...
type QnParams struct {
	PubKeyTypes []string `protobuf:"bytes,1,rep,name=pub_key_types,json=pubKeyTypes,proto3" json:"pub_key_types,omitempty"`
	Value       []uint64 `protobuf:"varint,2,rep,packed,name=value,proto3" json:"value,omitempty"`
}

func (m *QnParams) Reset()         { *m = QnParams{} }
func (m *QnParams) String() string { return proto.CompactTextString(m) }
func (*QnParams) ProtoMessage()    {}
func (*QnParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{5}
}
func (m *QnParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QnParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QnParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QnParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QnParams.Merge(m, src)
}
func (m *QnParams) XXX_Size() int {
	return m.Size()
}
func (m *QnParams) XXX_DiscardUnknown() {
	xxx_messageInfo_QnParams.DiscardUnknown(m)
}

var xxx_messageInfo_QnParams proto.InternalMessageInfo

func (m *QnParams) GetPubKeyTypes() []string {
	if m != nil {
		return m.PubKeyTypes
	}
	return nil
...
func (m *QnParams) GetValue() []uint64 {
	if m != nil {
		return m.Value
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QnParams)(nil), "reapchain.types.QnParams")
...
var fileDescriptor_49d6a79e7dce3f58 = []byte{
	...
	,
}
...
func (this *QnParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QnParams)
	if !ok {
		that2, ok := that.(QnParams)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *ConsensusParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.Qn.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QnParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QnParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QnParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func NewPopulatedQnParams(r randyParams, easy bool) *QnParams {
	this := &QnParams{}
	v3 := r.Intn(10)
...
func (m *ConsensusParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := m.Qn.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QnParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QnParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QnParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
