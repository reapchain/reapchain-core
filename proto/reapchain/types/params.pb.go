...
type ConsensusParams struct {
	...
	StandingMemberParam StandingMemberParam `protobuf:"bytes,5,opt,name=standing_member_param,json=standingMemberParam,proto3" json:"standing_member_param"`
}
...
func (m *ConsensusParams) GetStandingMemberParam() StandingMemberParam {
	if m != nil {
		return m.StandingMemberParam
	}
	return StandingMemberParam{}
}
...
type StandingMemberParam struct {
	PubKeyTypes []string `protobuf:"bytes,1,rep,name=pub_key_types,json=pubKeyTypes,proto3" json:"pub_key_types,omitempty"`
}

func (m *StandingMemberParam) Reset()         { *m = StandingMemberParam{} }
func (m *StandingMemberParam) String() string { return proto.CompactTextString(m) }
func (*StandingMemberParam) ProtoMessage()    {}
func (*StandingMemberParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{4}
}
func (m *StandingMemberParam) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StandingMemberParam) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StandingMemberParam.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StandingMemberParam) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StandingMemberParam.Merge(m, src)
}
func (m *StandingMemberParam) XXX_Size() int {
	return m.Size()
}
func (m *StandingMemberParam) XXX_DiscardUnknown() {
	xxx_messageInfo_StandingMemberParam.DiscardUnknown(m)
}

var xxx_messageInfo_StandingMemberParam proto.InternalMessageInfo

func (m *StandingMemberParam) GetPubKeyTypes() []string {
	if m != nil {
		return m.PubKeyTypes
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*StandingMemberParam)(nil), "reapchain.types.StandingMemberParam")
...
var fileDescriptor_49d6a79e7dce3f58 = []byte{
	...
	,
}
...
func (this *ConsensusParams) Equal(that interface{}) bool {
	...
	if !this.StandingMemberParam.Equal(&that1.StandingMemberParam) {
		return false
	}
	return true
}
...
func (this *StandingMemberParam) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StandingMemberParam)
	if !ok {
		that2, ok := that.(StandingMemberParam)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *ConsensusParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.StandingMemberParam.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *StandingMemberParam) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StandingMemberParam) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StandingMemberParam) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func NewPopulatedStandingMemberParam(r randyParams, easy bool) *StandingMemberParam {
	this := &StandingMemberParam{}
	v2 := r.Intn(10)
...
func (m *StandingMemberParam) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConsensusParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StandingMemberParam", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.StandingMemberParam.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StandingMemberParam) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StandingMemberParam: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StandingMemberParam: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
