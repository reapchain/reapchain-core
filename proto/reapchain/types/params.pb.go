...
// source: reapchain/types/params.proto
...
type ConsensusParams struct {
	...
	StandingMember StandingMemberParams `protobuf:"bytes,5,opt,name=standing_member,json=standingMember,proto3" json:"standing_member"`
	Qrn            QrnParams            `protobuf:"bytes,6,opt,name=qrn,proto3" json:"qrn"`
}
...
func (*ConsensusParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{0}
}
...
func (m *ConsensusParams) GetStandingMember() StandingMemberParams {
	if m != nil {
		return m.StandingMember
	}
	return StandingMemberParams{}
}

func (m *ConsensusParams) GetQrn() QrnParams {
	if m != nil {
		return m.Qrn
	}
	return QrnParams{}
...
func (*BlockParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{1}
}
...
func (*EvidenceParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{2}
}
...
func (*ValidatorParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{3}
}
...
type StandingMemberParams struct {
	PubKeyTypes []string `protobuf:"bytes,1,rep,name=pub_key_types,json=pubKeyTypes,proto3" json:"pub_key_types,omitempty"`
}

func (m *StandingMemberParams) Reset()         { *m = StandingMemberParams{} }
func (m *StandingMemberParams) String() string { return proto.CompactTextString(m) }
func (*StandingMemberParams) ProtoMessage()    {}
func (*StandingMemberParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{4}
}
func (m *StandingMemberParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StandingMemberParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StandingMemberParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StandingMemberParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StandingMemberParams.Merge(m, src)
}
func (m *StandingMemberParams) XXX_Size() int {
	return m.Size()
}
func (m *StandingMemberParams) XXX_DiscardUnknown() {
	xxx_messageInfo_StandingMemberParams.DiscardUnknown(m)
}

var xxx_messageInfo_StandingMemberParams proto.InternalMessageInfo

func (m *StandingMemberParams) GetPubKeyTypes() []string {
	if m != nil {
		return m.PubKeyTypes
	}
	return nil
...
type QrnParams struct {
	PubKeyTypes []string `protobuf:"bytes,1,rep,name=pub_key_types,json=pubKeyTypes,proto3" json:"pub_key_types,omitempty"`
	Value       []uint64 `protobuf:"varint,2,rep,packed,name=value,proto3" json:"value,omitempty"`
}

func (m *QrnParams) Reset()         { *m = QrnParams{} }
func (m *QrnParams) String() string { return proto.CompactTextString(m) }
func (*QrnParams) ProtoMessage()    {}
func (*QrnParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{5}
}
func (m *QrnParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QrnParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QrnParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QrnParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QrnParams.Merge(m, src)
}
func (m *QrnParams) XXX_Size() int {
	return m.Size()
}
func (m *QrnParams) XXX_DiscardUnknown() {
	xxx_messageInfo_QrnParams.DiscardUnknown(m)
}

var xxx_messageInfo_QrnParams proto.InternalMessageInfo

func (m *QrnParams) GetPubKeyTypes() []string {
	if m != nil {
		return m.PubKeyTypes
	}
	return nil
...
func (m *QrnParams) GetValue() []uint64 {
	if m != nil {
		return m.Value
	}
	return nil
...
func (*VersionParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{6}
}
...
func (*HashedParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_49d6a79e7dce3f58, []int{7}
}
...
func init() {
	proto.RegisterType((*ConsensusParams)(nil), "reapchain.types.ConsensusParams")
	proto.RegisterType((*BlockParams)(nil), "reapchain.types.BlockParams")
	proto.RegisterType((*EvidenceParams)(nil), "reapchain.types.EvidenceParams")
	proto.RegisterType((*ValidatorParams)(nil), "reapchain.types.ValidatorParams")
	proto.RegisterType((*StandingMemberParams)(nil), "reapchain.types.StandingMemberParams")
	proto.RegisterType((*QrnParams)(nil), "reapchain.types.QrnParams")
	proto.RegisterType((*VersionParams)(nil), "reapchain.types.VersionParams")
	proto.RegisterType((*HashedParams)(nil), "reapchain.types.HashedParams")
}

func init() { proto.RegisterFile("reapchain/types/params.proto", fileDescriptor_49d6a79e7dce3f58) }

var fileDescriptor_49d6a79e7dce3f58 = []byte{
	// 626 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *ConsensusParams) Equal(that interface{}) bool {
	...
	if !this.StandingMember.Equal(&that1.StandingMember) {
		return false
	}
	if !this.Qrn.Equal(&that1.Qrn) {
		return false
	}
	return true
}
...
func (this *StandingMemberParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StandingMemberParams)
	if !ok {
		that2, ok := that.(StandingMemberParams)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QrnParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QrnParams)
	if !ok {
		that2, ok := that.(QrnParams)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *StandingMemberParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StandingMemberParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StandingMemberParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QrnParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QrnParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QrnParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Value) > 0 {
		...
		i = encodeVarintParams(dAtA, i, uint64(j8))
		i--
		dAtA[i] = 0x12
	}
	if len(m.PubKeyTypes) > 0 {
...
func NewPopulatedStandingMemberParams(r randyParams, easy bool) *StandingMemberParams {
	this := &StandingMemberParams{}
	v2 := r.Intn(10)
...
func NewPopulatedQrnParams(r randyParams, easy bool) *QrnParams {
	this := &QrnParams{}
	v3 := r.Intn(10)
	this.PubKeyTypes = make([]string, v3)
	for i := 0; i < v3; i++ {
		this.PubKeyTypes[i] = string(randStringParams(r))
	}
	v4 := r.Intn(10)
	this.Value = make([]uint64, v4)
	for i := 0; i < v4; i++ {
		this.Value[i] = uint64(uint64(r.Uint32()))
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldParams(dAtA []byte, r randyParams, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateParams(dAtA, uint64(v6))
	case 1:
		dAtA = encodeVarintPopulateParams(dAtA, uint64(key))
...
func (m *StandingMemberParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StandingMemberParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StandingMemberParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StandingMemberParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QrnParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QrnParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QrnParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
