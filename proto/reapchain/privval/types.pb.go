...
import (
	...
	types "github.com/tendermint/tendermint/proto/reapchain/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
func init() { proto.RegisterFile("reapchain/privval/types.proto", fileDescriptor_cb4e437a5328cf9c) }
