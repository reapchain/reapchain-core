...
func (BlockIDFlag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{0}
}
...
func (SignedMsgType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{1}
}
...
func (*BlockID) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{2}
}
...
type Header struct {
	...
	StandingMembersHash          []byte         `protobuf:"bytes,15,opt,name=standing_members_hash,json=standingMembersHash,proto3" json:"standing_members_hash,omitempty"`
	ConsensusRound               ConsensusRound `protobuf:"bytes,16,opt,name=consensus_round,json=consensusRound,proto3" json:"consensus_round"`
	QrnsHash                     []byte         `protobuf:"bytes,17,opt,name=qrns_hash,json=qrnsHash,proto3" json:"qrns_hash,omitempty"`
	SteeringMemberCandidatesHash []byte         `protobuf:"bytes,18,opt,name=steering_member_candidates_hash,json=steeringMemberCandidatesHash,proto3" json:"steering_member_candidates_hash,omitempty"`
	VrfsHash                     []byte         `protobuf:"bytes,19,opt,name=vrfs_hash,json=vrfsHash,proto3" json:"vrfs_hash,omitempty"`
}
...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{3}
}
...
func (m *Header) GetStandingMembersHash() []byte {
	if m != nil {
		return m.StandingMembersHash
	}
	return nil
}

func (m *Header) GetConsensusRound() ConsensusRound {
	if m != nil {
...
func (m *Header) GetQrnsHash() []byte {
	if m != nil {
		return m.QrnsHash
	}
	return nil
...
func (m *Header) GetSteeringMemberCandidatesHash() []byte {
	if m != nil {
		return m.SteeringMemberCandidatesHash
	}
	return nil
}

func (m *Header) GetVrfsHash() []byte {
	if m != nil {
		return m.VrfsHash
	}
	return nil
...
func (*Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{4}
}
...
func (*Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{5}
}
...
func (*Commit) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{6}
}
...
type CommitSig struct {
	BlockIdFlag      BlockIDFlag `protobuf:"varint,1,opt,name=block_id_flag,json=blockIdFlag,proto3,enum=reapchain.types.BlockIDFlag" json:"block_id_flag,omitempty"`
...
func (*CommitSig) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{7}
}
...
func (*Proposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{8}
}
...
func (*SignedHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{9}
}
...
type LightBlock struct {
	...
	SteeringMemberCandidateSet *SteeringMemberCandidateSet `protobuf:"bytes,4,opt,name=steering_member_candidate_set,json=steeringMemberCandidateSet,proto3" json:"steering_member_candidate_set,omitempty"`
	QrnSet                     *QrnSet                     `protobuf:"bytes,5,opt,name=qrn_set,json=qrnSet,proto3" json:"qrn_set,omitempty"`
	VrfSet                     *VrfSet                     `protobuf:"bytes,6,opt,name=vrf_set,json=vrfSet,proto3" json:"vrf_set,omitempty"`
	NextQrnSet                 *QrnSet                     `protobuf:"bytes,7,opt,name=next_qrn_set,json=nextQrnSet,proto3" json:"next_qrn_set,omitempty"`
	NextVrfSet                 *VrfSet                     `protobuf:"bytes,8,opt,name=next_vrf_set,json=nextVrfSet,proto3" json:"next_vrf_set,omitempty"`
	SettingSteeringMember      *SettingSteeringMember      `protobuf:"bytes,9,opt,name=setting_steering_member,json=settingSteeringMember,proto3" json:"setting_steering_member,omitempty"`
}
...
func (*LightBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{10}
}
...
func (m *LightBlock) GetStandingMemberSet() *StandingMemberSet {
	if m != nil {
...
func (m *LightBlock) GetSteeringMemberCandidateSet() *SteeringMemberCandidateSet {
	if m != nil {
...
func (m *LightBlock) GetQrnSet() *QrnSet {
	if m != nil {
		return m.QrnSet
	}
	return nil
...
func (m *LightBlock) GetVrfSet() *VrfSet {
	if m != nil {
		return m.VrfSet
	}
	return nil
...
func (m *LightBlock) GetNextQrnSet() *QrnSet {
	if m != nil {
		return m.NextQrnSet
	}
	return nil
...
func (m *LightBlock) GetNextVrfSet() *VrfSet {
	if m != nil {
		return m.NextVrfSet
	}
	return nil
...
func (m *LightBlock) GetSettingSteeringMember() *SettingSteeringMember {
	if m != nil {
...
func (*BlockMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{11}
}
...
func (*TxProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1e1271ee2fdbd69, []int{12}
}
...
func init() {
	proto.RegisterEnum("reapchain.types.BlockIDFlag", BlockIDFlag_name, BlockIDFlag_value)
	proto.RegisterEnum("reapchain.types.SignedMsgType", SignedMsgType_name, SignedMsgType_value)
	proto.RegisterType((*PartSetHeader)(nil), "reapchain.types.PartSetHeader")
	proto.RegisterType((*Part)(nil), "reapchain.types.Part")
	proto.RegisterType((*BlockID)(nil), "reapchain.types.BlockID")
	proto.RegisterType((*Header)(nil), "reapchain.types.Header")
	proto.RegisterType((*Data)(nil), "reapchain.types.Data")
	proto.RegisterType((*Vote)(nil), "reapchain.types.Vote")
	proto.RegisterType((*Commit)(nil), "reapchain.types.Commit")
	proto.RegisterType((*CommitSig)(nil), "reapchain.types.CommitSig")
	proto.RegisterType((*Proposal)(nil), "reapchain.types.Proposal")
	proto.RegisterType((*SignedHeader)(nil), "reapchain.types.SignedHeader")
	proto.RegisterType((*LightBlock)(nil), "reapchain.types.LightBlock")
	proto.RegisterType((*BlockMeta)(nil), "reapchain.types.BlockMeta")
	proto.RegisterType((*TxProof)(nil), "reapchain.types.TxProof")
}

func init() { proto.RegisterFile("podc/types/types.proto", fileDescriptor_f1e1271ee2fdbd69) }

var fileDescriptor_f1e1271ee2fdbd69 = []byte{
	// 1586 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.VrfsHash) > 0 {
		i -= len(m.VrfsHash)
		copy(dAtA[i:], m.VrfsHash)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.VrfsHash)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
	}
	if len(m.SteeringMemberCandidatesHash) > 0 {
		i -= len(m.SteeringMemberCandidatesHash)
		copy(dAtA[i:], m.SteeringMemberCandidatesHash)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.SteeringMemberCandidatesHash)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	if len(m.QrnsHash) > 0 {
		i -= len(m.QrnsHash)
		copy(dAtA[i:], m.QrnsHash)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.QrnsHash)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
	...
	i--
	dAtA[i] = 0x82
	if len(m.StandingMembersHash) > 0 {
		i -= len(m.StandingMembersHash)
		copy(dAtA[i:], m.StandingMembersHash)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.StandingMembersHash)))
		i--
		dAtA[i] = 0x7a
	}
...
func (m *Header) Size() (n int) {
	...
	l = len(m.SteeringMemberCandidatesHash)
	if l > 0 {
		n += 2 + l + sovTypes(uint64(l))
	}
	l = len(m.VrfsHash)
...
func (m *Header) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StandingMembersHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StandingMembersHash = append(m.StandingMembersHash[:0], dAtA[iNdEx:postIndex]...)
			if m.StandingMembersHash == nil {
				m.StandingMembersHash = []byte{}
			}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QrnsHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QrnsHash = append(m.QrnsHash[:0], dAtA[iNdEx:postIndex]...)
			if m.QrnsHash == nil {
				m.QrnsHash = []byte{}
			}
			iNdEx = postIndex
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SteeringMemberCandidatesHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SteeringMemberCandidatesHash = append(m.SteeringMemberCandidatesHash[:0], dAtA[iNdEx:postIndex]...)
			if m.SteeringMemberCandidatesHash == nil {
				m.SteeringMemberCandidatesHash = []byte{}
			}
			iNdEx = postIndex
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VrfsHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VrfsHash = append(m.VrfsHash[:0], dAtA[iNdEx:postIndex]...)
			if m.VrfsHash == nil {
				m.VrfsHash = []byte{}
			}
			iNdEx = postIndex
...
func (m *LightBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.SettingSteeringMember == nil {
				m.SettingSteeringMember = &SettingSteeringMember{}
			}
