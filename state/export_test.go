...
func UpdateState(
	...
	stteringMemberCandidateUpdates []*types.SteeringMemberCandidate,
) (State, error) {
	return updateState(state, blockID, header, abciResponses, standingMemberUpdates, stteringMemberCandidateUpdates)
}
