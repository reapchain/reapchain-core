...
import (
	...
	state "gitlab.reappay.net/sucs-lab//reapchain/state"

	reapchainstate "gitlab.reappay.net/sucs-lab//reapchain/proto/reapchain/state"

	reapchaintypes "gitlab.reappay.net/sucs-lab//reapchain/types"
