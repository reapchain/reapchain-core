...
import (
	...
	state "gitlab.reappay.net/reapchain/reapchain-core/state"

	reapchainstate "gitlab.reappay.net/reapchain/reapchain-core/proto/reapchain/state"

	reapchaintypes "gitlab.reappay.net/reapchain/reapchain-core/types"
