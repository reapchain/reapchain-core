...
// See https://gitlab.reappay.net/reapchain/reapchain-core/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://gitlab.reappay.net/reapchain/reapchain-core/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://gitlab.reappay.net/reapchain/reapchain-core/issues/3531
