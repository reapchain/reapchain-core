...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/reapchain/reapchain-core' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/reapchain-core
    ln -s /vagrant /home/vagrant/go/src/github.com/reapchain/reapchain-core
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/reapchain/reapchain-core && make tools'
  SHELL
end
