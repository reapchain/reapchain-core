...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/reapchain/reapchain' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/reapchain
    ln -s /vagrant /home/vagrant/go/src/github.com/reapchain/reapchain
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/reapchain/reapchain && make tools'
  SHELL
end
