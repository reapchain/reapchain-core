...
* Here are some common library labels for consistency:
    ...
    * tmcmd "github.com/reapchain/reapchain/cmd/reapchain/commands"
    * tmcfg "github.com/reapchain/reapchain/config/reapchain"
    * tmtypes "github.com/reapchain/reapchain/types"
...
* When importing a pkg from the `reapchain/libs` directory, prefix the pkg alias with tm.
    * tmbits "github.com/reapchain/reapchain/libs/bits"
