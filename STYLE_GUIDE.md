...
* Product names are capitalized, like "ReapchainCore", "Basecoin", "Protobuf", etc except in command lines: `reapchain-core --help`
...
* When importing a pkg from the `reapchain-core/libs` directory, prefix the pkg alias with tm.
...
* Every repo should have a version/version.go file that mimics the ReapchainCore Core repo
