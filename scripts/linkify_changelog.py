...
# " [\#number](https://gitlab.reappay.net/reapchain/reapchain-core/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]*)", r" [\\#\1](https://gitlab.reappay.net/reapchain/reapchain-core/issues/\1)", line.rstrip())
    print(line)