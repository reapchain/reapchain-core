...
# " [\#number](https://gitlab.reappay.net/sucs-lab/reapchain/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]*)", r" [\\#\1](https://gitlab.reappay.net/sucs-lab/reapchain/issues/\1)", line.rstrip())
    print(line)