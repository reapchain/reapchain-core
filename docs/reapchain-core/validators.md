...
ReapchainCore has a different approach to block creation. Validators are
...
implemented on top of ReapchainCore consensus. That is, validators may be
...
1. They can be pre-established in the [genesis state](./using-reapchain-core.md#genesis)
...
Currently ReapchainCore uses [Ed25519](https://ed25519.cr.yp.to/) keys which are widely supported across the security sector and HSMs.
...
votes](https://github.com/reapchain-core/spec/blob/953523c3cb99fdb8c8f7a2d21e3a99094279e9de/spec/blockchain/blockchain.md#vote) for that block at the same `round`.
The +2/3 set of precommit votes is called a
[_commit_](https://github.com/reapchain-core/spec/blob/953523c3cb99fdb8c8f7a2d21e3a99094279e9de/spec/blockchain/blockchain.md#commit). While any +2/3 set of
...
[LastCommit](https://github.com/reapchain-core/spec/blob/953523c3cb99fdb8c8f7a2d21e3a99094279e9de/spec/blockchain/blockchain.md#lastcommit)).
