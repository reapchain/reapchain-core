...
Reapchain is required to monitor peer quality in order to inform its peer dialing and peer exchange strategies.
...
The trust metric capability is now available, yet, it still leaves the question of how should it be applied throughout Reapchain in order to properly track the quality of peers?
