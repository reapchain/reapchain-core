...
The original tracking issue for this is [#1648](https://github.com/reapchain/reapchain-core/issues/1648).
...
future](https://github.com/reapchain/reapchain-core/issues/2840).

Other concerns here include:

- Validator Address [#3596](https://github.com/reapchain/reapchain-core/issues/3596) -
    Should the CommitSig include the validator address? It is very convenient to
    do so, but likely not necessary. This was also discussed in [#2226](https://github.com/reapchain/reapchain-core/issues/2226).
- Absent Votes [#3591](https://github.com/reapchain/reapchain-core/issues/3591) -
...
- Other BlockIDs [#3485](https://github.com/reapchain/reapchain-core/issues/3485) -
...
BFT time [can be
mitigated](https://github.com/reapchain/reapchain-core/issues/2840#issuecomment-529122431).
