# ADR 052: Reapchain Mode

## Changelog

* 27-11-2019: Initial draft from ADR-051
* 13-01-2020: Separate ADR Reapchain Mode from ADR-051
...
We would like to suggest a simple Reapchain mode abstraction. These modes will live under one binary, and when initializing a node the user will be able to specify which node they would like to create.
...
- Configuration, cli command
    ...
    - `reapchain node --mode validator`  in cli
...
- Issue [#2237](https://github.com/reapchain/reapchain-core/issues/2237) : Reapchain "mode"
- [TenderSeed](https://gitlab.com/polychainlabs/tenderseed) : A lightweight Reapchain Seed Node.
